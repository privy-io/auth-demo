...
export function Header() {
  return (
    <header className="flex shrink-0 grow-0 flex-col items-center gap-y-4 py-5 md:flex-row">
      ...
      <div className="flex h-[34px] shrink-0 grow-0 flex-col items-center gap-x-4 gap-y-1 rounded-[17px] pl-4 pr-1 text-[14px] md:flex-row md:bg-privy-color-background-2">
